        ...
        >
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-4 md:flex md:items-center">
                    ...
                    <button
                        type="button"
                        class="ml-6 rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                    >
                        Add event
                    </button>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            W
                            <span
                                class="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 font-semibold text-white"
                                >12</span
                            >
                        </button>
                        <button
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            ...
                                            alt=""
                                            class="rounded-full bg-white w-4 h-4 opacity-80 group-hover:opacity-100 transition"
                                        />
...
const containerOffset = reactive({
    offsetHeight: 0,
});
...
onMounted(() => {
    ...
    if (container.value && containerNav.value && containerOffset)
