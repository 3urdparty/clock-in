                                    ...
                                    >
                                        ...
                                        >
                                            <div class="sm:col-span-2">
                                                ...
                                                >
                                                    <span
                                                        class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 px-3 text-gray-500 sm:text-sm text-slate-400"
                                                        >@</span
                                                    >
                                                    <input
                                                        type="text"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <select
                                                            ...
                                                            class="h-full rounded-md border-0 bg-transparent py-0 pl-3 pr-7 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm"
                                                        >
                                                            <option>MY</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="sm:col-span-4">
                                                ...
                                                <div class="mt-2">
                                                    <input
                                                        ...
                                                        type="email"
                                                        autocomplete="email"
                                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 transition disabled:bg-gray-50 disabled:cursor-not-allowed disabled:ring-slate-300 disabled:text-slate-300"
                                                        :class="{
