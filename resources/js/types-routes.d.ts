...
declare namespace App.Route {
  export type Name = '/' | 'api/calendar' | 'api/fingerprints/delete' | 'api/fingerprints/enroll' | 'api/queue' | 'api/scan' | 'api/statistics' | 'api/sync' | 'api/test' | 'api/user' | 'devices.destroy' | 'devices.employees.destroy' | 'devices.employees.index' | 'devices.employees.show' | 'devices.employees.store' | 'devices.employees.update' | 'devices.index' | 'devices.show' | 'devices.store' | 'devices.update' | 'employees.destroy' | 'employees.fingerprints.destroy' | 'employees.fingerprints.index' | 'employees.fingerprints.show' | 'employees.fingerprints.store' | 'employees.fingerprints.update' | 'employees.index' | 'employees.show' | 'employees.store' | 'employees.update' | 'fingerprints.destroy' | 'fingerprints.index' | 'fingerprints.show' | 'fingerprints.store' | 'fingerprints.update' | 'sanctum.csrf-cookie' | 'shifts.destroy' | 'shifts.index' | 'shifts.show' | 'shifts.store' | 'shifts.update' | 'up';
  export type Path = '/' | '/api/calendar' | '/api/devices' | '/api/devices/{device}' | '/api/devices/{device}/employees' | '/api/devices/{device}/employees/{employee}' | '/api/employees' | '/api/employees/{employee}' | '/api/employees/{employee}/fingerprints' | '/api/employees/{employee}/fingerprints/{fingerprint}' | '/api/fingerprints' | '/api/fingerprints/delete' | '/api/fingerprints/enroll' | '/api/fingerprints/{fingerprint}' | '/api/queue' | '/api/scan' | '/api/shifts' | '/api/shifts/{shift}' | '/api/statistics' | '/api/sync' | '/api/test' | '/api/user' | '/sanctum/csrf-cookie' | '/up';
